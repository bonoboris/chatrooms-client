...
const classNames = {
  base: {
    "*": "outline-purple-500/50 focus:outline-none focus:ring focus:ring-purple-500/50",
    body: "text-normal bg-neutral-200 antialiased transition-all dark:bg-neutral-800 text-base border-normal",
    h1: "text-4xl font-extrabold tracking-wider text-normal",
    h2: "text-2xl font-semibold tracking-wide text-normal",
    label: "text-muted",
    'input:not([type="radio"]):not([type="checkbox"]),textarea':
      "rounded border border-normal bg-neutral-100 px-2 py-1 shadow-none hover:border-neutral-500  hover:ring hover:ring-purple-500/50 focus:border-purple-700 dark:bg-neutral-900 dark:text-white",
  ...
  components: {
    ...
    ".btn-outlined":
      "rounded-lg border border-neutral-500 bg-transparent px-2 py-0.5 font-semibold tracking-wide text-neutral-700 hover:border-purple-700  hover:text-purple-700 hover:ring-2 hover:ring-purple-500/50 active:bg-neutral-200 dark:text-neutral-300 dark:active:bg-neutral-800",
    ".btn-filled":
      "rounded-lg border border-transparent bg-purple-700 px-2 py-0.5 font-semibold tracking-wide text-white  hover:bg-purple-800 hover:ring-2 hover:ring-purple-500/50 active:bg-purple-900 ",
  },
};
